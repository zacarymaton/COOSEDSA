              ...
              <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                  ...
                  <ul class="sub">
                    ...
                    <li class="active"><a  href="{{ url('/listar_servicios')}}">Listar Servicios</a></li>
                  </ul>
              </li>
              <li class="sub-menu">
                <a href="javascript:;" >
                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table  id="table_data" class="table table-striped table-advance table-hover" cellspacing="0" width="100%">
	                  	  	  <h4><i class="fa fa-angle-right"></i>Listado de Servicios</h4>
	                  	  	  <hr>
                              <thead>
                              <tr>
                                  <th><i class="fa fa-bullhorn"></i>Nombre del Servicio</th>
                                  <th><i class="fa fa-bullhorn"></i>Categoria del Servicio</th>
                                  <th class="hidden-phone"><i class="fa fa-question-circle"></i> hrs de trabajo</th>
                                  <th><i class="fa fa-bookmark"></i>Costo de Servicio</th>
                              ...
                              <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$value->categoria_servicio}}</td>
                                    <td>{{$value->hrs_trabajo}}</td>
                                    ...
                                    <form action="{{ route('deleteServicio', $value->id) }}" method="POST">
                                        {{ @csrf_field() }}
                                    </br>
