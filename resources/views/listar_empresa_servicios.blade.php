          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <li class="sub-menu">
                ...
                <ul class="sub">
                    ...
                    <li class="active" ><a  href="{{ url('/listar_empresa_servicios')}}">Listar Servicios Empresa</a></li>
                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table  id="table_data" class="table table-striped table-advance table-hover" cellspacing="0" width="100%">
	                  	  	  <h4><i class="fa fa-angle-right"></i>Listado de Servicios de la Empresa Disponibles</h4>
	                  	  	  <hr>
                              <thead>
                              <tr>
                                  <th><i class="fa fa-bullhorn"></i>Nombre de la Empresa</th>
                                  <th><i class="fa fa-bullhorn"></i>Pagina web</th>
                                  <th class="hidden-phone"><i class="fa fa-question-circle"></i>hrs atencion</th>
                                  <th><i class="fa fa-bookmark"></i>Region-Departamento</th>
                                  <th><i class="fa fa-bookmark"></i>Direccion</th>
                                  <th><i class="fa fa-bookmark"></i>Telefono</th>
                                  <th><i class="fa fa-bookmark"></i>Servicio</th>
                                  <th><i class="fa fa-bookmark"></i>Empleado</th>
                              ...
                              <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$value->hr_atencion}}</td>
                                    <td>{{$value->region_departamento}}</td>
                                    ...
                                    <form action="{{ route('deleteEmpesaServicio', $value->id) }}" method="POST">
                                        {{ @csrf_field() }}
                                    </br>
                                ...
                                @include('modificar_empresa_servicios')
                                @endforeach
                              </tbody>
                          </table>
