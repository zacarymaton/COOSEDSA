              ...
              <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                  ...
                  <ul class="sub">
                      ...
                      <li class="active"><a  href="{{ url('/registrar_personal')}}">Registrar Personal</a></li>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Registrar Empleado</h3>
          	<div class="row mt">

          		<! -- DATE PICKERS -->
	          	<div class="col-lg-12">
		          	<div class="form-panel">
		                  <form method="POST" action="/registrar_empleado" class="form-horizontal style-form"  enctype="multipart/form-data" >
                           @csrf
                            <div class="form-group has-success">
                                <label class="col-lg-2 control-label">Nombre</label>
                                <div class="col-lg-10">
                                    <input type="text" placeholder="Nombre del empleado" name="nombre_empleado" id="nombre_empleado" class="form-control">
                            ...
                            <div class="form-group has-success">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" placeholder="Apellido del Empleado"  name="apellidos_empleado" id="apellidos_empleado" class="form-control">
                                    <p class="help-block">colocar apellido paterno y materno</p>
                                </div>
                            </div>
		                      ...
		                      <div class="form-group has-success">
		                          ...
		                          <div class="col-md-3 col-xs-11">
		                              <div data-date-viewmode="years" data-date-format="dd-mm-yyyy" data-date="01-01-2014" class="input-append date dpYears">
		                                  <input type="text"  value="DD/MM/YY" size="16"  name="fecha_naci_empleado" id="fecha_naci_empleado" class="form-control">
		                                      <span class="input-group-btn add-on">
		                                        <button class="btn btn-theme" type="button"><i class="fa fa-calendar"></i></button>
		                                      </span>
		                              </div>
		                              <span class="help-block">Seleccione su fecha de Nacimiento</span>
		                          </div>
		                      </div>
                              <div class="form-group has-success">
                                <label class="col-lg-2 control-label">Nro Carnet</label>
                                <div class="col-lg-10">
                                    <input type="text" placeholder="Nro CI" name="nro_carnet_empleado" id="nro_carnet_empleado" class="form-control">
                                    <p class="help-block">Nro de CI del empleado</p>
                                </div>
                            </div>
                              <div class="form-group has-success">
                                <label class="col-lg-2 control-label">Direccion</label>
                                <div class="col-lg-10">
                                    <input type="text" placeholder="Direccion de domicilio del empleado" name="direccion_empleado" id="direccion_empleado" class="form-control">
                            ...
                            <div class="form-group has-success">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" placeholder="Nro Celular o Nro Fijo" name="telefono_empleado" id="telefono_empleado" class="form-control">
                              ...
                              <div class="form-group has-success">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" placeholder="indique ocupacion del empleado"  name="ocupacion" id="ocupacion" class="form-control select">

                                    <p class="help-block">Defina una ocupacion del empleado</p>
                                </div>
                            </div>
                            <div class="form-group has-success">
                                <label class="col-lg-2 control-label">Valor X Hr</label>
                                <div class="col-lg-10">
                                    <input type="text" placeholder="indique cuanto cobra x hr el empleado"  name="valor_hr" id="valor_hr" class="form-control select">

                                    <p class="help-block">Defina cuanto cobra por hr</p>
                                </div>
                            </div>
                            <div class="form-group has-success">
                                <label class="col-lg-2 control-label">Estado</label>
                                <div class="col-lg-10">
                                    <select name="estado_empleado" id="estado_empleado" class="form-control">
                                        <option value="" selected>seleccione un Estado</option>
                                        <option value="0">Activo</option>
                                        <option value="1" >Inactivo</option>
                                      </select>
                                    <p class="help-block">Defina un Estado</p>
                                </div>
                            </div>
                            <div class="form-group last">
                                    ...
                                    <div class="fileupload fileupload-new" data-provides="fileupload">
                                        ...
                                        <div>
                                            <span class="btn btn-theme02 btn-file">
                                                ...
                                                <input type="file" class="default" name="foto_empleado" />
                                            </span>
                                            <a href="{{ url('/registrar_personal')}}" class="btn btn-theme04 fileupload-exists" data-dismiss="fileupload"><i class="fa fa-trash-o"></i> Borrar Imagen</a>
                                        </div>
                                    </div>
                              ...
                              <div class="form-group">
                                <div class="col-lg-offset-2 col-lg-10">
                                    <button class="btn btn-theme" type="submit">Registrar Empleado</button>
