...
<!-- Mirrored from blacktie.co/demo/premium/dashio/dashboard/{{ url('/grids') }} by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Mar 2017 17:55:00 GMT -->
<head>
    <meta charset="utf-8">
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li class="active"><a  href="{{ url('/grids') }}">Grids</a></li>
