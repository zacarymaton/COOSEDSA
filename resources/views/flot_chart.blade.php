...
<!-- Mirrored from blacktie.co/demo/premium/dashio/dashboard/{{ url('/flot_chart')}} by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Mar 2017 17:56:42 GMT -->
<head>
    <meta charset="utf-8">
  ...
  <section id="container" >
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a  href="{{ url('/flot_chart')}}">Flot Charts</a></li>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <footer class="site-footer">
          <div class="text-center">
              2014 - Alvarez.is
              <a href="{{ url('/flot_chart')}}#" class="go-top">
    ...
    <script src="/js/flotchart-conf.js"></script>
...
<!-- Mirrored from blacktie.co/demo/premium/dashio/dashboard/{{ url('/flot_chart')}} by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Mar 2017 17:56:50 GMT -->
</html>
