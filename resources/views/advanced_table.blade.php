...
<!-- Mirrored from blacktie.co/demo/premium/dashio/dashboard/{{ url('/advanced_table')}} by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Mar 2017 17:56:14 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <link href="/js/advanced-datatable/media/css/demo_page.css" rel="stylesheet" />
    <link href="/js/advanced-datatable/media/css/demo_table.css" rel="stylesheet" />
    <link rel="stylesheet" href="/js/advanced-datatable/media/css/DT_bootstrap.css" />
  ...
  <section id="container" >
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a  href="{{ url('/advanced_table')}}">Advanced Table</a></li>
                      </ul>
                  </li>
                  <li>
                      <a  href="{{ url('/inbox')}}">
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <footer class="site-footer">
          <div class="text-center">
              2014 - Alvarez.is
              <a href="{{ url('/advanced_table')}}#" class="go-top">
	...
	<script type="text/javascript" language="javascript" src="/js/advanced-datatable/media/js/jquery.js"></script>
    <script src="/js/bootstrap.min.js"></script>
    <script class="include" type="text/javascript" src="/js/jquery.dcjqaccordion.2.7.js"></script>
    <script src="/js/jquery.scrollTo.min.js"></script>
    <script src="/js/jquery.nicescroll.js" type="text/javascript"></script>

    <script type="text/javascript" language="javascript" src="/js/advanced-datatable/media/js/jquery.dataTables.js"></script>
    <script type="text/javascript" src="/js/advanced-datatable/media/jsDT_bootstrap.html"></script>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function() {
          ...
          nCloneTd.innerHTML = '<img src="/js/advanced-datatable/examples/examples_support/details_open.png">';
          ...
          $('#hidden-table-info tbody td img').live('click', function () {
              ...
              if ( oTable.fnIsOpen(nTr) )
              {
                  ...
                  this.src = "/js/advanced-datatable/examples/examples_support/details_open.png";
                  oTable.fnClose( nTr );
              }
              else
              {
                  /* Open this row */
                  this.src = "/js/advanced-datatable/examples/examples_support/details_close.png";
...
<!-- Mirrored from blacktie.co/demo/premium/dashio/dashboard/{{ url('/advanced_table')}} by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Mar 2017 17:56:28 GMT -->
</html>
