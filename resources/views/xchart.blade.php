...
<!-- Mirrored from blacktie.co/demo/premium/dashio/dashboard/{{ url('/xchart')}} by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Mar 2017 17:56:50 GMT -->
<head>
    <meta charset="utf-8">
	...
	<link rel="stylesheet" href="/js/xchart/xcharts.css">
  ...
  <section id="container" >
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                        ...
                        <li class="active"><a  href="{{ url('/xchart')}}">xChart</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;">
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <footer class="site-footer">
          <div class="text-center">
              2014 - Alvarez.is
              <a href="{{ url('/xchart')}}#" class="go-top">
	...
	<script src="/js/xchart/d3.v3.min.js"></script>
	<script src="/js/xchart/xcharts.min.js"></script>
...
<!-- Mirrored from blacktie.co/demo/premium/dashio/dashboard/{{ url('/xchart')}} by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Mar 2017 17:56:55 GMT -->
</html>
