...
<!-- Mirrored from blacktie.co/demo/premium/dashio/dashboard/{{ url('/file_upload')}} by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Mar 2017 17:55:24 GMT -->
<head>
    <meta charset="utf-8">
  ...
  <section id="container" >
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                        ...
                        <li><a  href="{{ url('/todo_list') }}">Todo List</a></li>
                          ...
                          <li class="active"><a  href="{{ url('/file_upload')}}">Multiple File Upload</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <footer class="site-footer">
          <div class="text-center">
              2014 - Alvarez.is
              <a href="{{ url('/file_upload')}}#" class="go-top">
	...
	<script src="/file-uploader/js/cors/jquery.xdr-transport.js"></script>
	<![endif]-->
...
<!-- Mirrored from blacktie.co/demo/premium/dashio/dashboard/{{ url('/file_upload')}} by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Mar 2017 17:55:48 GMT -->
</html>
