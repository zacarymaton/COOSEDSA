...
<!-- Mirrored from blacktie.co/demo/premium/dashio/dashboard/{{ url('/general')}} by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Mar 2017 17:54:57 GMT -->
<head>
    <meta charset="utf-8">
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li class="active"><a  href="{{ url('/general')}}">General</a></li>
      ...
      *********************************************************************************************************************************************************** -->
      			...
      			<div class="col-lg-6 col-md-6 col-sm-12">
      				...
      				<div class="showback">
      					<h4><i class="fa fa-angle-right"></i> Gritter Examples</h4>
							...
							<a id="remove-all" class="btn btn-danger  btn-sm" href="{{ url('/general')}}#">Remove all</a>
      				</div><!-- /showback -->
      ...
      <footer class="site-footer">
          <div class="text-center">
              2014 - Alvarez.is
              <a href="{{ url('/general')}}#" class="go-top">
...
<!-- Mirrored from blacktie.co/demo/premium/dashio/dashboard/{{ url('/general')}} by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Mar 2017 17:54:58 GMT -->
</html>
