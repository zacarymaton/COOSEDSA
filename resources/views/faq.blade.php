...
<!-- Mirrored from blacktie.co/demo/premium/dashio/dashboard/{{ url('/faq')}} by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Mar 2017 17:55:49 GMT -->
<head>
    <meta charset="utf-8">
          ...
          <div class="row mt mb">
    		<div class="col-lg-12">
				...
				<div class="col-lg-4 col-md-4 col-sm-12">
                	<div class="dmbox">
                        <div class="service-icon">
                            <a class="" href="{{ url('/faq')}}#"><i class="dm-icon fa fa-question fa-3x"></i></a>
                        </div>
				...
				<div class="col-lg-4 col-md-4 col-sm-12">
                	<div class="dmbox">
                        <div class="service-icon">
                            <a class="" href="{{ url('/faq')}}#"><i class="dm-icon fa fa-envelope-o fa-3x"></i></a>
                        </div>
				...
				<div class="col-lg-4 col-md-4 col-sm-12">
                	<div class="dmbox">
                        <div class="service-icon">
                            <a class="" href="{{ url('/faq')}}#"><i class="dm-icon fa fa-random fa-3x"></i></a>
                        </div>
               ...
               <div class="accordion" id="accordion2">
                  <div class="accordion-group">
                    <div class="accordion-heading">
                      <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="{{ url('/faq')}}#collapseOne">
                  ...
                  <div class="accordion-group">
                    <div class="accordion-heading">
                      <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="{{ url('/faq')}}#collapseTwo">
                  ...
                  <div class="accordion-group">
                    <div class="accordion-heading">
                      <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="{{ url('/faq')}}#collapseThree">
                  ...
                  <div class="accordion-group">
                    <div class="accordion-heading">
                      <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="{{ url('/faq')}}#collapseFour">
                    ...
                    <div id="collapseFour" class="accordion-body collapse">
                      ...
                      <div class="accordion-group">
                        <div class="accordion-heading">
                          <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="{{ url('/faq')}}#collapseFive">
