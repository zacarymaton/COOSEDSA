...
<!-- Mirrored from blacktie.co/demo/premium/dashio/dashboard/{{ url('/chartjs')}} by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Mar 2017 17:56:39 GMT -->
<head>
    <meta charset="utf-8">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a  href="{{ url('/chartjs')}}">Chartjs</a></li>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <footer class="site-footer">
          <div class="text-center">
              2014 - Alvarez.is
              <a href="{{ url('/chartjs')}}#" class="go-top">
...
<!-- Mirrored from blacktie.co/demo/premium/dashio/dashboard/{{ url('/chartjs')}} by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Mar 2017 17:56:42 GMT -->
</html>
