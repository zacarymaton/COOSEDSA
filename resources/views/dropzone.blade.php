...
<!-- Mirrored from blacktie.co/demo/premium/dashio/dashboard/{{ url('/dropzone') }} by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Mar 2017 17:55:22 GMT -->
<head>
    <meta charset="utf-8">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                        ...
                        <li><a  href="{{ url('/todo_list') }}">Todo List</a></li>
                          <li class="active"><a  href="{{ url('/dropzone') }}">Dropzone File Upload</a></li>
      ...
      *********************************************************************************************************************************************************** -->
          ...
          <section class="wrapper site-min-height">
              ...
              <div class="white-panel mt">
                  <div class="panel-body">
                      <form action="http://blacktie.co/demo/premium/dashio/dashboard//dropzone/upload.php" class="dropzone" id="my-awesome-dropzone"></form>
                  </div>
              </div>
          	</div>
      ...
      <footer class="site-footer">
          <div class="text-center">
              2014 - Alvarez.is
              <a href="{{ url('/dropzone') }}#" class="go-top">
...
<!-- Mirrored from blacktie.co/demo/premium/dashio/dashboard/{{ url('/dropzone') }} by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Mar 2017 17:55:24 GMT -->
</html>
