...
<!-- Mirrored from blacktie.co/demo/premium/dashio/dashboard/{{ url('/form_component')}} by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Mar 2017 17:55:53 GMT -->
<head>
    <meta charset="utf-8">
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li class="active"><a  href="{{ url('/form_component')}}">Registrar Cliente</a></li>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <footer class="site-footer">
          <div class="text-center">
              2014 - Alvarez.is
              <a href="{{ url('/form_component')}}#" class="go-top">
...
<!-- Mirrored from blacktie.co/demo/premium/dashio/dashboard/{{ url('/form_component')}} by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Mar 2017 17:56:03 GMT -->
</html>
