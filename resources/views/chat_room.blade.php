...
<!-- Mirrored from blacktie.co/demo/premium/dashio/dashboard/{{ url('/chat_room')}} by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Mar 2017 17:56:55 GMT -->
<head>
    <meta charset="utf-8">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a  href="{{ url('/chat_room')}}"> Chat Room</a></li>
                      </ul>
                  </li>
                  <li>
      ...
      *********************************************************************************************************************************************************** -->
                  ...
                  <aside class="mid-side">
                      ...
                      <div class="group-rom">
                          ...
                          <div class="second-part"><a href="#">product.jpg</a> <span class="text-muted">35.4KB</span>
                              <p><img class="img-responsive" src="/img/product.jpg" alt=""></p></div>
                          <div class="third-part">12:32</div>
                      </div>
                      <div class="group-rom">
                          <div class="first-part">Mark Simmons</div>
      ...
      <footer class="site-footer">
          <div class="text-center">
              2014 - Alvarez.is
              <a href="{{ url('/chat_room')}}#" class="go-top">
