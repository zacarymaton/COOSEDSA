...
<!-- Mirrored from blacktie.co/demo/premium/dashio/dashboard/{{ url('/lobby')}} by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Mar 2017 17:56:55 GMT -->
<head>
    <meta charset="utf-8">
              ...
              <div class="chat-room mt">
                  <aside class="mid-side">
                      ...
                      <div class="room-desk">
                          ...
                          <div class="room-box">
                              <h5 class="text-primary"><a href="{{ url('/chat_room')}}">Dashboard</a></h5>
                          ...
                          <div class="room-box">
                              <h5 class="text-primary"><a href="{{ url('/chat_room')}}">Support</a></h5>
                          ...
                          <div class="room-box">
                              <h5 class="text-primary"><a href="{{ url('/chat_room')}}">MaxFront</a></h5>
                      ...
                      <div class="room-desk">
                          ...
                          <div class="room-box">
                              <h5 class="text-primary"><a href="{{ url('/chat_room')}}">Dash Stats</a></h5>
                          ...
                          <div class="room-box">
                              <h5 class="text-primary"><a href="{{ url('/chat_room')}}">Gold Clients</a></h5>
