                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table  id="table_data" class="table table-striped table-advance table-hover" cellspacing="0" width="100%">
                              ...
                              <tbody>
                                {{-- <tr>
                                    <td><a href="{{ url('/basic_table')}}#">Company Ltd</a></td>
                                    <td><a href="{{ url('/basic_table')}}#">Company Ltd</a></td>
                                    <td><a href="{{ url('/basic_table')}}#">Company Ltd</a></td>
                                    <td><a href="{{ url('/basic_table')}}#">Company Ltd</a></td>
                                ...
                                <tr>
                                    <td><a href="{{ url('/basic_table')}}#">Total Ltd</a></td>
                                    <td><a href="{{ url('/basic_table')}}#">Total Ltd</a></td>
                                    <td><a href="{{ url('/basic_table')}}#">Total Ltd</a></td>
                                    <td><a href="{{ url('/basic_table')}}#">Total Ltd</a></td>
                                    <td class="hidden-phone">Lorem Ipsum dolor</td>
                                ...
                                <tr>
                                    ...
                                    <form action="{{ route('deleteCliente', $value->id) }}" method="POST">
                                        {{ @csrf_field() }}
                                    </br>
