          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                    ...
                    <ul class="sub">
                      <li class="active"><a  href="{{ url('/registrar_servicio')}}">Registrar Servicios</a></li>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Registrar Servicios</h3>
          	<div class="row mt">

          		<! -- DATE PICKERS -->
	          	<div class="col-lg-12">
		          	<div class="form-panel">
		                  <form method="POST" action="/registrar_servicio_nuevo" class="form-horizontal style-form">
                           @csrf
                            <div class="form-group has-success">
                                <label class="col-lg-2 control-label">Nombre Servicio</label>
                                <div class="col-lg-10">
                                    <input type="text" placeholder="Nombre del servicio" name="nombre_servicio" id="nombre_servicio" class="form-control">
                            ...
                            <div class="form-group has-success">
                                ...
                                <div class="col-lg-10">
                                    <select type="text" placeholder="Alta, Estandar o Basica"  name="categoria_servicio" id="categoria_servicio" class="form-control">
                                        <option value="">Seleccione: Alta, Estandar o Basica</option>
		                      ...
		                      <div class="form-group has-success">
		                          <label class="col-lg-2 control-label"> Hr de Trabajo del Servicio</label>
		                          <div class="col-md-3 col-xs-11">

		                              <div data-date-viewmode="years" data-date-format="dd-mm-yyyy" data-date="01-01-2014" class="input-append date dpYears">
		                                  <input type="time" value="00:00" size="16"  name="hrs_trabajo" id="hrs_trabajo" class="form-control">
		                                      <span class="input-group-btn add-on">
		                                        {{--  <button class="btn btn-theme" type="button"></button>  --}}
		                                      </span>
		                              </div>
		                              <span class="help-block">Seleccione cantidad de hrs del servicio</span>
		                          </div>
		                      </div>
                              <div class="form-group has-success">
                                <label class="col-lg-2 control-label">Costo del Servicio</label>
                                <div class="col-lg-10">
                                    <input type="number" placeholder="costo por el Servicio" name="costo_servicio" id="costo_servicio" class="form-control">
                                    <p class="help-block">Ingrese un costo de servicio</p>
                                </div>
                            </div>
                              <div class="form-group has-success">
                                <label class="col-lg-2 control-label">Descripcion del Servicio</label>
                                <div class="col-lg-10">
                                    <input type="text" placeholder="Que se se realiza durante el servicio" name="descripcion_servicio" id="descripcion_servicio" class="form-control">
                                    <p class="help-block">descripcion del tipo de servicio</p>
                                </div>
                            </div>
                            <div class="form-group has-success">
                                <label class="col-lg-2 control-label">Estado del servicio</label>
                                <div class="col-lg-10">
                                    ...
                                    {{--  <input type="number" min="0" max="1" pattern="[0-1]{0,1}" placeholder="Solo colocar 0=activo o 1=no activo" name="estado" id="estado" class="form-control">  --}}
                                    <p class="help-block">Colocar un estado al servicio</p>
                                </div>
                            </div>
                              <div class="form-group">
                                <div class="col-lg-offset-2 col-lg-10">
                                    <button class="btn btn-theme" type="submit">Registrar Servicio</button>
