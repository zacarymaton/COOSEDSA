...
<!-- Mirrored from blacktie.co/demo/premium/dashio/dashboard/{{ url('/inline_editor') }} by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Mar 2017 17:55:24 GMT -->
<head>
    <meta charset="utf-8">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                        ...
                        <li><a  href="{{ url('/todo_list') }}">Todo List</a></li>
                          ...
                          <li class="active"><a  href="{{ url('/inline_editor') }}">Inline Editor</a></li>
      ...
      *********************************************************************************************************************************************************** -->
          ...
          <section class="wrapper site-min-height">
			...
			<div class="row content-panel mt mb">
				...
				<div class="col-md-6">
					...
					<p contenteditable="true">"I pray please to give me some action (work) for I am very poor boy I have no one to help me even so father for it so it seemed in thy good sight, you give the Telegraph Office, and another work what is your wish I am very poor boy, this understand what is your wish you my father I am your son this understand what is your wish.</p>
				</div>
			</div>
			<div class="mt"></div>
			<div class="row content-panel mt mb">
				...
				<div class="col-md-6">
					...
					<p contenteditable="true">Danglars shuddered. The bandage fell from his eyes, and he understood the joke, which he did not think quite so stupid as he had done just before. "Come," he said, "if I pay you the 100,000 francs, will you be satisfied, and allow me to eat at my ease?"</p>
				</div>
			</div>
			<div class="mt"></div>
      ...
      <footer class="site-footer">
          <div class="text-center">
              2014 - Alvarez.is
              <a href="{{ url('/inline_editor') }}#" class="go-top">
