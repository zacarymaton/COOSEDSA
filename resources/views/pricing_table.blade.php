...
<!-- Mirrored from blacktie.co/demo/premium/dashio/dashboard/{{ url('/pricing_table')}} by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Mar 2017 17:55:49 GMT -->
<head>
    <meta charset="utf-8">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                        ...
                        <li><a  href="{{ url('/lock_screen')}}">Lock Screen</a></li>
                          ...
                          <li class="active"><a  href="{{ url('/pricing_table')}}">Pricing Table</a></li>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <footer class="site-footer">
          <div class="text-center">
              2014 - Alvarez.is
              <a href="{{ url('/pricing_table')}}#" class="go-top">
